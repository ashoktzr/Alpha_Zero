...
## 📊 High-Quality Runs Logging

Alpha Zero automatically logs high-quality cluster runs (Precision ≥ 50%, Coverage ≥ 3%) to help improve the project.

**Default behavior**: Runs are logged to a shared Google Sheet (no setup needed!)

**Want private logging?** See [WEBHOOK_SETUP.md](WEBHOOK_SETUP.md) to configure your own private Google Sheets webhook.
